<template>
  <div>
    ...
    <Modal :mdShow="modalConfirm" @close="closeModal()">
      ...
      <div slot="btnGroup"  >
        <a class="btn btn--m" @click="delCart()" href="javascript:;">确认</a><!--点确认额会有弹框-->
    ...
    export default {
      ...
      methods:{
        ...
        delCartConfirm(productId){
          this.productId=productId;//将获取到的productId全局保存
