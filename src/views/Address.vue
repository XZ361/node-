<template>
  <div>
      ...
      <div class="container">
        <div class="checkout-addr">
          ...
          <div class="next-btn-wrap">
            ...
            <router-link class="btn btn--m btn--red" style="color:white;" v-bind:to="{path:'orderConfirm',query:{'addressId':selectedAddrId}}">Next</router-link>
          </div>
        </div>
      </div>
    </div>
    <modal :mdShow="isMdShow" @close="closeModal()">
      ...
      <div slot="btnGroup">
        <a class="btn btn--m" @click="delAddress()" href="javascript:;">确认</a><!--点确认额会有弹框-->
        <a class="btn btn--m" @click="isMdShow=false" href="javascript:;">关闭</a>
      </div>
    </modal>
      ...
      methods:{
        ...
        setDefault(addressId){
          axios.post('/users/setDefault',{
            ...
            let res=response.data;
            this.init();
            console.log('set default seccess!');
          })
        },
        closeModal(){
          this.isMdShow=false;
