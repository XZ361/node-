       ...
       <div class="checkout-order">
               ...
               <li v-for="item in cartList" v-if="item.checked=='1'">
                 ...
                 <div class="cart-tab-3">
                   <div class="item-quantity">
                     ...
                     <div class="item-stock item-stock-no">In Stock</div><!--有库存-->
                   </div>
                 </div>
         ...
         <div class="order-foot-wrap">
           <div class="prev-btn-wrap">
             <router-link to="/address" class="btn btn--m">
  ...
  import axios from 'axios'
    export default{
      ...
      methods:{
        ...
        payMent(){
          var addressId=this.$route.query.addressId;//可以通过$route获取路由参数
          axios.post('/users/payMent',{
            //post请求可以直接接传参，get请求需要加上params
            addressId:addressId,
